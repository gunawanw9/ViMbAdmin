...
class Log
{
    ...
    const ACTION_DOMAIN_EDIT          = 'DOMAIN_ADD';
    ...
    const ACTION_CANONICAL_ADD            = 'CANONICAL_ADD';
    const ACTION_CANONICAL_EDIT           = 'CANONICAL_EDIT';
    const ACTION_CANONICAL_ACTIVATE       = 'CANONICAL_ACTIVATE';
    const ACTION_CANONICAL_DEACTIVATE     = 'CANONICAL_DEACTIVATE';
    const ACTION_CANONICAL_DELETE         = 'CANONICAL_DELETE';
    /**
     * @var string $action
     */
    private $action;
