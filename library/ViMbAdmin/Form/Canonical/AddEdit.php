...
/**
 * The form for adding and editing canonical.
 *
 * @package ViMbAdmin
 * @subpackage Form
 */
class ViMbAdmin_Form_Canonical_AddEdit extends ViMbAdmin_Form
{

    public function init()
    {
        $this->setDecorators( array( array( 'ViewScript', array( 'viewScript' => 'canonical/form/add-edit.phtml' ) ) ) );

        $this->setMethod( 'post' )
            ->setAttrib( 'id', 'canonical_edit_form' )
            ->setAttrib( 'name', 'canonical_edit_form' );
